...
export function VouchForNewMember({
  ...
  // Filter to roles the user can vouch for — memoized to prevent re-render loop
  // (.filter() creates a new array reference each render, which would re-trigger the useEffect below)
