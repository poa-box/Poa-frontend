 ...
 * Multi-step onboarding UI for creating a passkey account and joining an org.
 */
...
/**
 * Map onboarding steps to progress bar values (0-100)
 */
const STEP_PROGRESS = {
...
export default function PasskeyOnboardingModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleClose = () => {
    if (isInProgress) return; // Don't allow closing during onboarding
