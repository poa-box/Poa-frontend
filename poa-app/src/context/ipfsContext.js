...
export const IPFSprovider = ({ children }) => {
    ...
    const addToIpfs = useCallback(async (content) => {
        ...
        // to avoid ipfs-http-client's Uint8Array handling which corrupts binary data
        // (86KB PNG becomes 149KB due to UTF-8 multi-byte encoding of high bytes).
        // For strings (JSON metadata), use ipfs-http-client normally.
        ...
        try {
            ...
            if (isBinary) {
                ...
                addedData = await withRetry(async () => {
                    ...
                    // The Graph's IPFS API returns { Hash, Size, Name }
